...
// Package ethclient provides a client for the PHPChain RPC API.
package ethclient
...
import (
	...
	"github.com/phpchain/go-phpchain"
...
// Client defines typed wrappers for the PHPChain RPC API.
type Client struct {
	c *rpc.Client
}
...
func (ec *Client) TransactionByHash(ctx context.Context, hash common.Hash) (tx *types.Transaction, isPending bool, err error) {
	...
	if err != nil {
		...
		return nil, false, phpchain.NotFound
	}
...
func (ec *Client) SyncProgress(ctx context.Context) (*phpchain.SyncProgress, error) {
	var raw json.RawMessage
...
func (ec *Client) SubscribeNewHead(ctx context.Context, ch chan<- *types.Header) (phpchain.Subscription, error) {
...
func (ec *Client) FilterLogs(ctx context.Context, q phpchain.FilterQuery) ([]types.Log, error) {
...
func (ec *Client) SubscribeFilterLogs(ctx context.Context, q phpchain.FilterQuery, ch chan<- types.Log) (phpchain.Subscription, error) {
	return ec.c.EthSubscribe(ctx, ch, "logs", toFilterArg(q))
}

func toFilterArg(q phpchain.FilterQuery) interface{} {
...
func (ec *Client) CallContract(ctx context.Context, msg phpchain.CallMsg, blockNumber *big.Int) ([]byte, error) {
...
func (ec *Client) PendingCallContract(ctx context.Context, msg phpchain.CallMsg) ([]byte, error) {
	var hex hexutil.Bytes
...
func (ec *Client) EstimateGas(ctx context.Context, msg phpchain.CallMsg) (*big.Int, error) {
	var hex hexutil.Big
...
func toCallArg(msg phpchain.CallMsg) interface{} {
	arg := map[string]interface{}{
		"from": msg.From,
		"to":   msg.To,
	}
