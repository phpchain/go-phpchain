...
import (
	...
	"github.com/phpchain/go-phpchain/logger"
	"github.com/phpchain/go-phpchain/p2p"
	"github.com/phpchain/go-phpchain/p2p/nat"
	"github.com/phpchain/go-phpchain/whisper"
)
...
func main() {
	...
	// Create an PHPChain peer to communicate through
	server := p2p.Server{
		PrivateKey: key,
		MaxPeers:   10,
		Name:       name,
	...
	fmt.Println("Starting PHPChain peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start PHPChain peer: %v.\n", err)
		os.Exit(1)
	}
