...
import (
	...
	"github.com/phpchain/go-phpchain/crypto/ecies"
	"github.com/phpchain/go-phpchain/event/filter"
...
// Whisper represents a dark communication interface through the PHPChain
...
// New creates a Whisper client ready to communicate through the PHPChain P2P
// network.
func New() *Whisper {
	whisper := &Whisper{
		filters:     filter.New(),
