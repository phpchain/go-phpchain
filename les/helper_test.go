...
import (
	...
	"github.com/phpchain/go-phpchain/les/flowcontrol"
...
func testChainGen(i int, block *core.BlockGen) {
	...
	switch i {
	case 0:
		// In block 1, the test bank sends account #1 some php.
		...
		block.AddTx(tx)
	case 1:
		// In block 2, the test bank sends some more php to account #1.
