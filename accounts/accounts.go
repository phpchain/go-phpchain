...
// Package accounts implements high level PHPChain account management.
package accounts
...
// Account represents an PHPChain account located at a specific location defined
// by the optional URL field.
type Account struct {
	Address common.Address `json:"address"` // PHPChain account address derived from the key
...
type Wallet interface {
	...
	// chain state reader.
	SelfDerive(base DerivationPath, chain phpchain.ChainStateReader)
