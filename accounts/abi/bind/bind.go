...
// Package bind generates PHPChain contract Go bindings.
//
// Detailed usage document and tutorial available on the go-phpchain Wiki page:
// https://github.com/phpchain/go-phpchain/wiki/Native-DApps:-Go-bindings-to-PHPChain-contracts
package bind
