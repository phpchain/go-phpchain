...
// setting up a new or managing an existing PHPChain private network.
func (w *wizard) run() {
	fmt.Println("+-----------------------------------------------------------+")
	fmt.Println("| Welcome to puppeth, your PHPChain private network manager |")
	fmt.Println("|                                                           |")
	fmt.Println("| This tool lets you create a new PHPChain network down to  |")
	...
	log.Info("Administering PHPChain network", "name", w.network)
