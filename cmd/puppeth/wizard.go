...
type wizard struct {
	...
	services map[string][]string   // PHPChain services known to be running on servers
...
// converts it to an PHPChain address. If an empty line is entered, the default
// value is returned.
