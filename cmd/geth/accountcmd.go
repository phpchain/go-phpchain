...
var (
	walletCommand = cli.Command{
		Name:      "wallet",
		Usage:     "Manage PHPChain presale wallets",
		ArgsUsage: "",
		Category:  "ACCOUNT COMMANDS",
		Description: `
    geth wallet import /path/to/my/presale.wallet

will prompt for your password and imports your php presale account.
		...
		Subcommands: []cli.Command{
			{
				...
				Name:      "import",
				Usage:     "Import PHPChain presale wallet",
				ArgsUsage: "<keyFile>",
...
between phpchain nodes by simply copying.
...
Note:
As you can directly copy your encrypted accounts to another phpchain instance,
