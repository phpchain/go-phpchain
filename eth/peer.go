...
// PeerInfo represents a short summary of the PHPChain sub-protocol metadata known
// about a connected peer.
type PeerInfo struct {
	Version    int      `json:"version"`    // PHPChain protocol version negotiated
