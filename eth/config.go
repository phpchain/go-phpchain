...
// DefaultConfig contains default settings for use on the PHPChain main net.
...
type Config struct {
	...
	// If nil, the PHPChain main net block is used.
	...
	PHPbase    common.Address `toml:",omitempty"`
