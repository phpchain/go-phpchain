...
// Syncing provides information when this nodes starts synchronising with the PHPChain network and when it's finished.
...
type SyncingResult struct {
	...
	Status  phpchain.SyncProgress `json:"status"`
}
