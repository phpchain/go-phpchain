...
// Contains all the wrappers from the go-phpchain root package.
...
// the PHPChain network.
type SyncProgress struct {
	progress phpchain.SyncProgress
}
