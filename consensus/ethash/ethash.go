...
// all blocks' seal as valid, though they still have to conform to the PHPChain
// consensus rules.
...
// still have to conform to the PHPChain consensus rules.
...
// they still have to conform to the PHPChain consensus rules.
