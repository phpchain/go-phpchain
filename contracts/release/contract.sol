...
// ReleaseOracle is an PHPChain contract to store the current and previous
// versions of the go-phpchain implementation. Its goal is to allow Geth to
...
contract ReleaseOracle {
  ...
  // updateSigner marks a vote for changing the status of an PHPChain user, either
