...
// Package chequebook package wraps the 'chequebook' PHPChain smart contract.
//
// The functions in this package allow using chequebook for
// issuing, receiving, verifying cheques in php; (auto)cashing cheques in php 
// as well as (auto)depositing php to the chequebook contract.
package chequebook
...
import (
	...
	"github.com/phpchain/go-phpchain/contracts/chequebook/contract"
	"github.com/phpchain/go-phpchain/core/types"
	"github.com/phpchain/go-phpchain/crypto"
	"github.com/phpchain/go-phpchain/log"
	"github.com/phpchain/go-phpchain/swarm/services/swap/swap"
)
...
// * depositing php to the chequebook
// * watching incoming php 
...
// Cash cashes the cheque by sending an PHPChain transaction.
