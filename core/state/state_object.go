...
// stateObject represents an PHPChain account which is being modified.
//
...
type stateObject struct {
	...
	addrHash common.Hash // hash of phpchain address of the account
	data     Account
	db       *StateDB
...
// Account is the PHPChain consensus representation of accounts.
