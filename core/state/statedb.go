...
// Package state provides a caching layer atop the PHPChain state trie.
package state
...
// StateDBs within the phpchain protocol are used to store anything
...
//
// Carrying over the balance ensures that PHP doesn't disappear.
