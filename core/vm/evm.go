...
type Context struct {
	...
	// sufficient php to transfer the value
	CanTransfer CanTransferFunc
	// Transfer transfers php from one account to the other
...
// EVM is the PHPChain Virtual Machine base object and provides
...
type EVM struct {
	...
	// evm.
	vmConfig Config
	// global (to this context) phpchain virtual machine
