...
// DefaultGenesisBlock returns the PHPChain main net genesis block.
func DefaultGenesisBlock() *Genesis {
	return &Genesis{
		Config:     params.MainnetChainConfig,
		Nonce:      84,
		ExtraData:  hexutil.MustDecode("0x4368696e612062616e7320616c6c2049434f7300000000000000000000000000"),
		GasLimit:   5000,
