...
// Package types contains data types related to PHPChain consensus.
package types
...
// Header represents a block header in the PHPChain blockchain.
type Header struct {
...
// Block represents an entire block in the PHPChain blockchain.
type Block struct {
	header       *Header
	uncles       []*Header
...
// DecodeRLP decodes the PHPChain
...
// EncodeRLP serializes b into the PHPChain RLP block format.
